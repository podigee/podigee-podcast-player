...
var $, ChapterMark, ChromeCast, Embed, Feed, MediaElement, Playlist, PodigeePodcastPlayer, Theme, Utils, _,
...
PodigeePodcastPlayer = (function() {
  function PodigeePodcastPlayer(elemClass) {
    ...
    this.updateScrubber = bind(this.updateScrubber, this);
    ...
    this.scrubberWidth = bind(this.scrubberWidth, this);
  ...
  PodigeePodcastPlayer.prototype.scrubberWidth = function() {
    return this.scrubberRailElement.width();
  };

  PodigeePodcastPlayer.prototype.initScrubber = function() {
    var newWidth;
  ...
  PodigeePodcastPlayer.prototype.initLoadingAnimation = function() {
  ...
  PodigeePodcastPlayer.prototype.switchTimeDisplay = function() {
    this.options.timeMode = this.options.timeMode === 'countup' ? 'countdown' : 'countup';
    return this.updateTime();
  };

  PodigeePodcastPlayer.prototype.timeRailFactor = function() {
    var duration;
    duration = this.player.duration;
    return this.scrubberWidth() / duration;
  };

  PodigeePodcastPlayer.prototype.secondsToHHMMSS = function(seconds) {
    var hours, minutes;
  ...
  PodigeePodcastPlayer.prototype.hhmmssToSeconds = function(string) {
  ...
  PodigeePodcastPlayer.prototype.padNumber = function(number) {
    if (number < 10) {
      return "0" + number;
    } else {
      return number;
  ...
  PodigeePodcastPlayer.prototype.updateScrubber = function() {
    var newWidth;
    newWidth = this.player.currentTime * this.timeRailFactor();
    return this.scrubberPlayedElement.width(newWidth);
  };

  PodigeePodcastPlayer.prototype.updateLoaded = function(event) {
  ...
  PodigeePodcastPlayer.prototype.jumpToPosition = function(position) {
  ...
  PodigeePodcastPlayer.prototype.handleMouseMove = function(event) {
    var position;
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":12,"../../vendor/javascripts/lodash-3.10.1.js":13,"../../vendor/javascripts/mediaelement.js":14,"./chaptermark.coffee":3,"./chromecast.coffee":4,"./embed.coffee":5,"./feed.coffee":6,"./playlist.coffee":8,"./theme.coffee":10,"./utils.coffee":11}],3:[function(require,module,exports){
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":12,"../../vendor/javascripts/rivets.min.js":15,"../../vendor/javascripts/sightglass.js":16}],4:[function(require,module,exports){
var ChromeCast,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":12,"./iframe_resizer.coffee":7}],6:[function(require,module,exports){
var $, Feed;
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":12}],7:[function(require,module,exports){
var IframeResizer;
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":12,"./playlist_item.coffee":9}],9:[function(require,module,exports){
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":12,"../../vendor/javascripts/rivets.min.js":15,"../../vendor/javascripts/sightglass.js":16}],10:[function(require,module,exports){
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":12,"../../vendor/javascripts/rivets.min.js":15,"../../vendor/javascripts/sightglass.js":16}],11:[function(require,module,exports){
var Utils;
...
},{"sightglass":1}],16:[function(require,module,exports){
(function() {
  // Public sightglass interface.
  function sightglass(obj, keypath, callback, options) {
    return new Observer(obj, keypath, callback, options)
