...
var $, ChapterMarks, ChromeCast, Embed, Feed, Player, Playlist, PodigeePodcastPlayer, ProgressBar, Theme, Utils, _,
...
PodigeePodcastPlayer = (function() {
  function PodigeePodcastPlayer(elemClass) {
    ...
    this.playlistClickCallback = bind(this.playlistClickCallback, this);
  ...
  PodigeePodcastPlayer.prototype.getFeed = function() {
    ...
    return this.feed = new Feed(this.podcast.feedUrl);
  };
  ...
  PodigeePodcastPlayer.prototype.initPlayer = function() {
    ...
    return new Player(mediaElem, this.options, this.init);
  };
  ...
  PodigeePodcastPlayer.prototype.playlistClickCallback = function(event) {
    var item;
    item = event.data;
    this.data.title = item.title;
    this.data.subtitle = item.subtitle;
    this.data.description = item.description;
    return this.data.playlist.mp3 = item.enclosure;
  };

  PodigeePodcastPlayer.prototype.initPlaylist = function() {
    var self;
    if (!this.feed) {
      return;
    }
    self = this;
    return this.feed.promise.done(function() {
      return self.playlist = new Playlist(self.feed.items, self.theme.playlistElement, self.playlistClickCallback);
    });
  };

  PodigeePodcastPlayer.prototype.chapterClickCallback = function(event) {
    var time;
    time = event.data.start;
    return this.player.media.currentTime = Utils.hhmmssToSeconds(time);
  };

  PodigeePodcastPlayer.prototype.initChaptermarks = function() {
    var chaptermarks;
    chaptermarks = new ChapterMarks(this.episode.chaptermarks, this.theme.chaptermarksElement, this.chapterClickCallback);
    return this.theme.chaptermarksButtonElement.on('click', (function(_this) {
      return function() {
        return _this.toggleElement(chaptermarks.elem);
      };
    })(this));
  };

  PodigeePodcastPlayer.prototype.initMoreInfo = function() {
    return this.theme.moreInfoButtonElement.on('click', (function(_this) {
      return function() {
        return _this.toggleElement(_this.theme.moreInfoElement);
      };
    })(this));
  };
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"../../vendor/javascripts/lodash-3.10.1.js":16,"./chaptermarks.coffee":4,"./chromecast.coffee":5,"./embed.coffee":6,"./feed.coffee":7,"./player.coffee":9,"./playlist.coffee":10,"./progress_bar.coffee":12,"./theme.coffee":13,"./utils.coffee":14}],3:[function(require,module,exports){
var $, ChapterMark, rivets, sightglass,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"../../vendor/javascripts/rivets.min.js":18,"../../vendor/javascripts/sightglass.js":19}],4:[function(require,module,exports){
var $, ChapterMark, ChapterMarks;
...
ChapterMarks = (function() {
  function ChapterMarks(chaptermarks, elem, button, callback) {
    var html;
    this.elem = elem;
    ...
    html = $('<ul>');
    chaptermarks.forEach((function(_this) {
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"./chaptermark.coffee":3}],5:[function(require,module,exports){
var ChromeCast,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"./iframe_resizer.coffee":8}],7:[function(require,module,exports){
var $, Feed;
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15}],8:[function(require,module,exports){
var IframeResizer;
...
Player = (function() {
  function Player(elem, options, callback) {
    var self;
    this.options = options;
  ...
  Player.prototype.setPlaySpeed = function(speed) {
    return this.media.playbackRate = this.options.currentPlaybackRate = speed;
  };
...
},{"../../vendor/javascripts/mediaelement.js":17}],10:[function(require,module,exports){
...
Playlist = (function() {
  function Playlist(items, container, callback) {
    var list, self;
    this.items = items;
    ...
    this.container.show(400, this.sendHeightChange);
  }
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"./playlist_item.coffee":11}],11:[function(require,module,exports){
var $, PlaylistItem, rivets, sightglass,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"../../vendor/javascripts/rivets.min.js":18,"../../vendor/javascripts/sightglass.js":19}],12:[function(require,module,exports){
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"./utils.coffee":14}],13:[function(require,module,exports){
...
Theme = (function() {
  ...
  Theme.prototype.findElements = function() {
    ...
    this.chaptermarksButtonElement = this.elem.find('.chaptermarks-button');
    this.chaptermarksElement = this.elem.find('.chaptermarks');
    this.moreInfoButtonElement = this.elem.find('.more-info-button');
    this.moreInfoElement = this.elem.find('.more-info');
    this.playlistButtonElement = this.elem.find('.playlist-button');
    return this.playlistElement = this.elem.find('.playlist');
  };
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"../../vendor/javascripts/rivets.min.js":18,"../../vendor/javascripts/sightglass.js":19}],14:[function(require,module,exports){
var Utils;
...
Utils = (function() {
  ...
  Utils.padNumber = function(number) {
    if (number < 10) {
      return "0" + number;
    } else {
      return number;
...
},{"sightglass":1}],19:[function(require,module,exports){
(function() {
  // Public sightglass interface.
  function sightglass(obj, keypath, callback, options) {
    return new Observer(obj, keypath, callback, options)
