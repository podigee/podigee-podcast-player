...
var $, ChapterMarks, ChromeCast, Embed, Feed, Player, Playlist, PodigeePodcastPlayer, ProgressBar, Theme, Utils,
...
PodigeePodcastPlayer = (function() {
  ...
  PodigeePodcastPlayer.prototype.getProductionData = function() {
    ...
    return $.getJSON(this.data.productionDataUrl).done((function(_this) {
      return function(data) {
        return self.data.productionData = data.data;
      };
    })(this));
  };
  ...
  PodigeePodcastPlayer.prototype.getFeed = function() {
    ...
    return this.feed = new Feed(this.data.feedUrl, this.playlistElement).fetch();
  };

  PodigeePodcastPlayer.prototype.setOptions = function(options, frameOptions) {
    this.options = $.extend(true, this.defaultOptions, options);
    return this.options = $.extend(true, this.options, frameOptions);
  };

  PodigeePodcastPlayer.prototype.renderTheme = function() {
    this.theme = new Theme(this.elemClass, this.data);
  ...
  PodigeePodcastPlayer.prototype.findElements = function() {
  ...
  PodigeePodcastPlayer.prototype.initProgressBar = function() {
    return this.progressBar = new ProgressBar(this.progressBarElement, this.player.media, this.options.timeMode);
  };
  ...
  PodigeePodcastPlayer.prototype.adjustPlaySpeed = function(timeString) {
    ...
    if (!this.data.productionData) {
      return;
    }
    currentTime = this.player.media.currentTime;
    item = $.grep(this.data.productionData.statistics.music_speech, function(item, index) {
  ...
  PodigeePodcastPlayer.prototype.bindButtons = function() {
    ...
    return this.speedElement.click((function(_this) {
  ...
  PodigeePodcastPlayer.prototype.initPlaylist = function() {
    ...
    return this.feed.promise.done(function() {
      return self.playlist = new Playlist(self.feed.items, self.playlistElement, self.playlistClickCallback);
    });
  };
  ...
  PodigeePodcastPlayer.prototype.initChaptermarks = function() {
    var chaptermarks;
    chaptermarks = new ChapterMarks(this.data.chaptermarks, this.chaptermarksElement, this.chapterClickCallback);
    return this.chaptermarksButtonElement.on('click', (function(_this) {
      return function() {
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"./chaptermarks.coffee":4,"./chromecast.coffee":5,"./embed.coffee":6,"./feed.coffee":7,"./player.coffee":9,"./playlist.coffee":10,"./progress_bar.coffee":12,"./theme.coffee":13,"./utils.coffee":14}],3:[function(require,module,exports){
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"../../vendor/javascripts/rivets.min.js":17,"../../vendor/javascripts/sightglass.js":18}],4:[function(require,module,exports){
...
},{"../../vendor/javascripts/mediaelement.js":16}],10:[function(require,module,exports){
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"../../vendor/javascripts/rivets.min.js":17,"../../vendor/javascripts/sightglass.js":18}],12:[function(require,module,exports){
...
Theme = (function() {
  ...
  Theme.prototype.rerender = function() {
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":15,"../../vendor/javascripts/rivets.min.js":17,"../../vendor/javascripts/sightglass.js":18}],14:[function(require,module,exports){
var Utils;
...
},{"sightglass":1}],18:[function(require,module,exports){
(function() {
  // Public sightglass interface.
  function sightglass(obj, keypath, callback, options) {
    return new Observer(obj, keypath, callback, options)
