...
var $, ChapterMark, ChromeCast, Embed, Feed, MediaElement, Playlist, PodigeePodcastPlayer, ProgressBar, Theme, Utils, _,
...
PodigeePodcastPlayer = (function() {
  function PodigeePodcastPlayer(elemClass) {
    ...
    this.initAudioPlayer = bind(this.initAudioPlayer, this);
  ...
  PodigeePodcastPlayer.prototype.initAudioPlayer = function() {
    var audioElem;
  ...
  PodigeePodcastPlayer.prototype.init = function(player, elem) {
    this.player = player;
    this.findElements();
  ...
  PodigeePodcastPlayer.prototype.initProgressBar = function() {
    return this.progressBar = new ProgressBar(this.progressBarElement, this.player, this.options.timeMode);
  };
  ...
  PodigeePodcastPlayer.prototype.changePlaySpeed = function() {
    var nextRateIndex;
  ...
  PodigeePodcastPlayer.prototype.setPlaySpeed = function(speed) {
  ...
  PodigeePodcastPlayer.prototype.jumpBackward = function(seconds) {
    seconds = seconds || this.options.backwardSeconds;
    return this.player.currentTime = this.player.currentTime - seconds;
  };

  PodigeePodcastPlayer.prototype.jumpForward = function(seconds) {
  ...
  PodigeePodcastPlayer.prototype.chapterClickCallback = function(event) {
    ...
    return this.player.currentTime = Utils.hhmmssToSeconds(time);
  };

  PodigeePodcastPlayer.prototype.initChaptermarks = function() {
    var html;
    if (!this.data.chaptermarks.length) {
      return;
    }
    html = $('<ul>');
    this.data.chaptermarks.forEach((function(_this) {
      return function(item, index, array) {
        var chaptermark;
        chaptermark = new ChapterMark(item, _this.chapterClickCallback).render();
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":13,"../../vendor/javascripts/lodash-3.10.1.js":14,"../../vendor/javascripts/mediaelement.js":15,"./chaptermark.coffee":3,"./chromecast.coffee":4,"./embed.coffee":5,"./feed.coffee":6,"./playlist.coffee":8,"./progress_bar.coffee":10,"./theme.coffee":11,"./utils.coffee":12}],3:[function(require,module,exports){
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":13,"../../vendor/javascripts/rivets.min.js":16,"../../vendor/javascripts/sightglass.js":17}],4:[function(require,module,exports){
var ChromeCast,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":13,"./iframe_resizer.coffee":7}],6:[function(require,module,exports){
var $, Feed;
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":13}],7:[function(require,module,exports){
var IframeResizer;
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":13,"./playlist_item.coffee":9}],9:[function(require,module,exports){
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":13,"../../vendor/javascripts/rivets.min.js":16,"../../vendor/javascripts/sightglass.js":17}],10:[function(require,module,exports){
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":13,"./utils.coffee":12}],11:[function(require,module,exports){
...
},{"../../vendor/javascripts/jquery.1.11.0.min.js":13,"../../vendor/javascripts/rivets.min.js":16,"../../vendor/javascripts/sightglass.js":17}],12:[function(require,module,exports){
var Utils;
...
},{"sightglass":1}],17:[function(require,module,exports){
(function() {
  // Public sightglass interface.
  function sightglass(obj, keypath, callback, options) {
    return new Observer(obj, keypath, callback, options)
